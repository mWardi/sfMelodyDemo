...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'locations'                  => new sfWidgetFormFilterInput(),
      'twitter_id'                 => new sfWidgetFormFilterInput(),
      'twitter_oauth_token'        => new sfWidgetFormFilterInput(),
      'twitter_oauth_token_secret' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'twitter_id'                 => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'twitter_oauth_token'        => new sfValidatorPass(array('required' => false)),
      'twitter_oauth_token_secret' => new sfValidatorPass(array('required' => false)),
